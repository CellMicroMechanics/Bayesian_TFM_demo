...
%
% This artificial test data involves 15 circular traction spots with having constant
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 x = reshape(test_traction.r_pos(:,1),[52,52]);
 y = reshape(test_traction.r_pos(:,2),[52,52]);
 ff = reshape(ft(:,1),[52,52]);
